      ...
      >
        <div className="px-5 py-4">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-[#F2F2F7] rounded-apple-md text-sm text-gray-900 placeholder-apple-gray outline-none focus:ring-2 focus:ring-apple-blue/40 transition-all"
          />
        </div>
        ...
        <div className="px-5 py-3 border-t border-apple-divider flex justify-end gap-3">
          ...
          <button
            ...
            disabled={!value.trim()}
            className="px-4 py-1.5 text-sm font-medium text-apple-blue hover:bg-blue-50 rounded-apple-sm transition-colors disabled:text-apple-gray disabled:opacity-50 disabled:hover:bg-transparent"
          >
            确定
          </button>
        </div>
