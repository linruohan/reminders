...
export function TitleBar({ currentView, onViewChange, theme, onToggleTheme }: TitleBarProps) {
  ...
  return (
    <header className="flex items-center gap-3 px-4 h-11 select-none shrink-0 w-full">
